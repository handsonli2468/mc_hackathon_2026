...
local_parameters = [{'name': 'camera_resolution', 'default': '640,360,30',
                    ...
                    {'name': 'serial_no1', 'default': os.getenv('WHITE_SERIAL_BACK', '_218622278300'), 'description': 'camera1 serial number'},
                    {'name': 'serial_no2', 'default': os.getenv('WHITE_SERIAL_LEFT', '_218622278918'), 'description': 'camera2 serial number'},
                    ...
                    {'name': 'serial_no3', 'default': os.getenv('WHITE_SERIAL_RIGHT', '_419122270673'), 'description': 'camera3 serial number'},
                    ]
